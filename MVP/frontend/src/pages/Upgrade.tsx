...
const ARTIST_PLANS: PricingTable = {
  ...
  amateur: {
    ...
    perks: ["5 portfolio images", "Featured placement (Top 100)", "7% commission"],
    cta: "Upgrade to Amateur",
  },
  pro: {
    label: "Pro",
    ...
    perks: ["10 portfolio images", "Featured placement (Top 50)", "5% commission"],
    cta: "Upgrade to Pro",
    popular: true,
  },
  elite: {
    ...
    perks: ["15 portfolio images", "Featured placement (Top 25)", "0% commission"],
    cta: "Upgrade to Elite",
  },
};
