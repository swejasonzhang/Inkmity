            ...
            <div className="rounded-2xl bg-card p-5 sm:p-6 md:p-8 text-center border border-app">
                <LazyMotion features={domAnimation} strict>
                    <MotionConfig reducedMotion={prefersReduced ? "always" : "never"}>
                        ...
                        <div className="mt-8 grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-1.5 sm:gap-4 auto-rows-fr">
                            {rows.map(([title, body]) => (
                                <m.div
                                    key={title}
                                    variants={item}
                                ...
                                >
                                    ...
                                    <p className="mt-2 text-[color:var(--fg)]/80 max-w-prose mx-auto leading-relaxed">{body}</p>
                                </m.div>
                            ))}
                        </div>
                    </MotionConfig>
