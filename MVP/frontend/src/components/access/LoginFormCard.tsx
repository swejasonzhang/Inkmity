...
export default function LoginFormCard({ showInfo, hasError, titleOverride, subtitleOverride, children, className, hideHeader }: Props) {
    ...
    return (
        ...
        >
            <div className={`${isShowingSuccess ? "rounded-3xl" : showInfo ? "rounded-b-3xl md:rounded-tr-3xl md:rounded-br-3xl md:rounded-tl-none md:rounded-bl-none" : "rounded-3xl"} w-full h-full m-0 bg-card border border-app p-5 sm:p-6 mx-auto flex flex-col items-center justify-center overflow-hidden`}>
                {shouldShowForm ? (
