...
export default function LoginFormCard({ showInfo, hasError, titleOverride, subtitleOverride, children, className, hideHeader }: Props) {
    ...
    return (
        ...
        >
            <div className={`${isShowingSuccess ? "rounded-3xl" : showInfo ? "rounded-b-3xl md:rounded-tr-3xl md:rounded-br-3xl md:rounded-tl-none md:rounded-bl-none" : "rounded-3xl"} w-full m-0 bg-card border border-app p-4 sm:p-5 h-full mx-auto flex flex-col items-center justify-center overflow-hidden`}>
                {shouldShowForm ? (
