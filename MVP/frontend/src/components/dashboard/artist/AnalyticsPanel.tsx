                        ...
                        <div className="mt-6 grid grid-cols-2 gap-3 text-sm">
                            ...
                            <div className="rounded-lg bg-card border border-app px-3 py-2">
                                ...
                                <div className="mt-2 flex items-center justify-center gap-2">
                                    <div className="text-[12px] text-muted-foreground">Rev</div>
                                    <div className="font-semibold">${mtd.revenuePerHour}</div>
                                    <div className="text-[12px] text-muted-foreground">– Supplies</div>
                                    <div className="font-semibold">${mtd.suppliesCostPerHour}</div>
                                    <div className="text-[12px] text-muted-foreground">=</div>
                                    <div className="font-bold">
                                        ${Math.max(0, (mtd.revenuePerHour! - mtd.suppliesCostPerHour!)).toFixed(0)}
                                    </div>
                                </div>
                            </div>
                        </div>
