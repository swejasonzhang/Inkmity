...
const { requireAuthWithRevocation } = await import("./middleware/auth.js");
app.use("/api/dashboard", requireAuthWithRevocation(), dashboardRoutes);
app.use("/api/messages", requireAuthWithRevocation(), messageRoutes);
