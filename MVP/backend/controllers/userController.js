...
export async function getArtists(req, res) {
  ...
  const [total, items] = await Promise.all([
    ...
    Artist.find(filter)
      ...
      .limit(pageSize)
      .select(
        "_id clerkId username handle role location shop styles yearsExperience baseRate bookingPreference travelFrequency rating reviewsCount bookingsCount createdAt bio portfolioImages pastWorks healedWorks sketches avatar"
      )
      .lean(),
  ]);
  res.json({
